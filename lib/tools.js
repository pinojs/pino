...
const levels = require('./standard-levels');

function noop () {}

function genLog (levelValOfMethod) {
  return function LOG (o, ...n) {
    if (levelValOfMethod < levels[this[rootLevelSym]]) {

      // don't write the log if this method's log severity is lower than what the logger is configured to write
      return;
    }
    if (typeof o === 'object' && o !== null) {
      ...
      this[writeSym](o, format(null, n, this[formatOptsSym]), levelValOfMethod)
    } else this[writeSym](null, format(o, n, this[formatOptsSym]), levelValOfMethod)
  }
}
