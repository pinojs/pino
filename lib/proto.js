...
// Note: the name chindings is already used in line 66 as the result of the string calculation.
// now it is really misleading
function chindings () {
  const stream = this[streamSym]
  if (stream) return getChindings(stream.lastLogger)
  else return getChindings()
}
