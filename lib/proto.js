...
function child (bindings) {
  ...
  if (bindings.hasOwnProperty('formatters')) {
    instance[formattersSym] = {
      level: bindings.formatters.level || formatters.level,
      bindings: bindings.formatters.bindings || resetChildingsFormatter,
      log: bindings.formatters.log || formatters.log
    }
  } else {
    instance[formattersSym] = {
      level: formatters.level,
      bindings: resetChildingsFormatter,
      log: formatters.log
    }
  }
