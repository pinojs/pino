...
function child (bindings, options) {
  ...
  instance[chindingsSym] = asChindings(instance, bindings)
  // Always call setLevel when options are provided to ensure child loggers
  // get their own method references instead of inheriting from the parent.
  // This prevents issues when parent methods are wrapped (e.g., by Sinon).
  const childLevel = options.level !== undefined ? options.level : this.level
