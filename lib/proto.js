...
function child (bindings) {
  ...
  if (bindings.hasOwnProperty('formatters')) {
    instance[formattersSym] = new Formatters(
      bindings.formatters.level || formatters.level,
      bindings.formatters.bindings || resetChildingsFormatter,
      bindings.formatters.log || formatters.log
    )
  } else {
    instance[formattersSym] = new Formatters(
      formatters.level,
