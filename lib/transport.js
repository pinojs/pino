...
function setupOnExit (stream) {
  ...
  if (process.env.JEST_WORKER_ID) {
    // We need to ship some production code to support jest because we
    // cannot trust our environment to work as process and require have
    // been tinkered with.
    /* global afterAll */
    afterAll(function () {
      stream.end()
    })
  } else if (global.WeakRef && global.WeakMap && global.FinalizationRegistry) {
