// Wrapper for Pino types, allows all top level exports to also be exported as a namespace.
...
declare namespace P {
    ...
    export interface MultiStreamRes {
        write: (data: any) => void,
...
// Export the merged namespace + function
export = P;
